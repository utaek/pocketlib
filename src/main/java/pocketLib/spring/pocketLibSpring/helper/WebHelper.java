package pocketLib.spring.pocketLibSpring.helper;
...
public class WebHelper {
	...
	public ModelAndView redirect(String url, String msg) {
		...
		// 구성된 HTML을 출력한다.
		/*
		 * try { PrintWriter out = this.response.getWriter(); out.print(html); } catch
	...
	public ModelAndView redirect(String url, String msg, boolean isClose) {
		...
		if (isClose) {
			html += "<script type='text/javascript'>self.close();</script>";
		} else {
			html += "<script type='text/javascript'>opener.document.getElementById('check_user_id').value='check';</script>";
